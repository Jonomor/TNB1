        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="grid grid-cols-1 gap-8">
            {posts.map((post) => (
              <article 
                key={post.id}
                className="bg-charcoal border border-white/10 p-8 hover:border-electric-teal/50 transition-all cursor-pointer group"
              >
                ...
                <button className="text-electric-teal font-mono text-sm uppercase tracking-wider hover:text-white transition-colors flex items-center gap-2">
                  Read Analysis
